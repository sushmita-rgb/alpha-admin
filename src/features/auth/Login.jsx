...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-notion-bg dark:bg-notion-dark-bg text-notion-text dark:text-notion-dark-text transition-colors duration-150 select-none overflow-hidden font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative bg-gradient-to-b from-[#101827] to-[#0C1320]">
        ...
        >
          ...
          <div className="text-center lg:text-left space-y-2">
            <div className="inline-flex lg:hidden w-8 h-8 rounded-lg bg-[#3B82F6] items-center justify-center text-white text-sm font-bold mb-1 shadow-[0_0_15px_rgba(59,130,246,0.3)]">
              A
            </div>
          ...
          {/* Form container */}
          <div className="bg-[#171C26] border border-white/6 backdrop-blur-md rounded-[18px] shadow-[0_20px_60px_rgba(0,0,0,0.35)] p-8 space-y-5">
